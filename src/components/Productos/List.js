...
function List() {
    ...
    else if (stockFilter === 'Entre 0-10') matchesStock = product.stock >= 0 && product.stock <= 10;
    else if (stockFilter === 'Entre 11-50') matchesStock = product.stock >= 11 && product.stock <= 50;
    else if (stockFilter === 'Mas de 50') matchesStock = product.stock > 50;

    if (priceFilter === 'Todos') matchesPrice = true;
    else if (priceFilter === 'Entre 1-5') matchesPrice = product.precioVenta >= 1 && product.precioVenta <= 5;
    else if (priceFilter === 'Entre 6-10') matchesPrice = product.precioVenta >= 6 && product.precioVenta <= 10;
    else if (priceFilter === 'Mas de 10') matchesPrice = product.precioVenta > 10;

    if (searchTerm === '') matchesSearch = true;
    else matchesSearch = product.name.toLowerCase().includes(searchTerm.toLowerCase());
